...
TARGET_PER_SOURCE = 6000  # 6k QQP + 6k declarative = 12k train, matching v4's scale
...
# --- Declarative (SQuAD/CNN news, via humarin/chatgpt-paraphrases) ---
...
print(final)
final.save_to_disk("../training_data_v5_split")
print("\nSaved to training_data_v5_split/")